    ...
    describe('_.filter', function () {
      ...
      describe('fruits', function () {
        ...
        describe('startsWith', function () {
          ...
          it('should return an array containing strings starting with given letter', function () {
    ...
    describe('_.map', function () {
      ...
      describe('desserts', function () {
        ...
        describe('glutenFree', function () {
          ...
          it('should return new array with all items possessing a glutenFree status', function () {
            var data = glutenFree(testDesserts);
